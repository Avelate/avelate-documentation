...
## Система пріоритетів {docsify-ignore}
...
## Читання конфігураційних файлів {docsify-ignore}
...
## Конфігурація логера {docsify-ignore}

### Logstash / Elasticsearch / Kibana {docsify-ignore}
...
Сервіс фабрик призначений для створення конфігурованих екземплярів результуючих, системних об'єктів.
...
#### Обробка з'єднань {docsify-ignore}
...
Сервіс стрімів призначений для створення, обробки та віддачі стрімів з бінарними даними.
